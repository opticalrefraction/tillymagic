...
TIPS_CONTENT = {
    ...
    "Classes": [
        ...
        "",
        "─── Undertaker ──────────────────────────────────────",
        "  Slow, hard-hitting axe fighter. 85 HP.",
        "  Every hit with Axe adds 1 Sentence stack (max 5).",
        "  At 5 stacks, Execution fires automatically (80 dmg).",
        "  1: Axe           Melee hit + Sentence stack",
        "  2: Parry         0.8s window: counter next boss hit,",
        "                   reflect 2x dmg + add 1 stack on hit.",
        "  3: Chain Drag    Pull boss to melee range. 10 dmg.",
        "  4: Execution     Manual trigger (requires stacks).",
        "  5: Guillotine (ULT)  8 x total stacks ever accumulated.",
        "  TIP: Chain Drag into Axe spam is your bread and butter.",
        "",
        "─── Glasswright ─────────────────────────────────────",
        "  Terrain trapper with 75 HP. Fragile but devious.",
        "  1: Glass Shiv    Fast melee. +40% dmg if boss in shards.",
        "  2: Place Pane    Place a glass pane. Max 4 active.",
        "                   Panes are solid terrain for the boss.",
        "  3: Shatter       Manually break nearest pane into",
        "                   bleed shards. Shards deal 5 dmg/0.5s.",
        "  4: Prism Blast   Fire a beam from EACH active pane.",
        "                   More panes = more simultaneous hits.",
        "  5: Grand Facade (ULT)  8 panes ring the arena border.",
        "  TIP: Place → Blast → Shatter → Blast for massive burst.",
        "",
        "─── Bellwether ──────────────────────────────────────",
        "  Resource manager. No personal damage. 100 HP.",
        "  1: Summon        Summon a follower (max 5, 5s cd).",
        "  2: Rally Cry     Send all followers charging at boss.",
        "  3: Dispatch      Toggle Wall Mode: followers form a",
        "                   barrier between you and boss.",
        "  4: Martyrdom     Sacrifice lowest-HP follower for",
        "                   50 dmg + 0.6s stun.",
        "  5: The Charge (ULT)  All followers rush simultaneously.",
        "     35 dmg each + 2s stun. Scales with follower count.",
        "  TIP: Keep followers in Wall Mode until you need burst.",
        "",
        "─── Ashwalker ───────────────────────────────────────",
        "  Area denier. 95 HP. Fast mover.",
        "  Every tile you walk auto-ignites as an ember (2s).",
        "  Boss standing on embers takes 3 dmg/0.5s.",
        "  1: Cinder Strike Melee hit. +40% dmg if boss on ember.",
        "  2: Ignition      Double all ember damage for 2s.",
        "  3: Backdraft     Scatter 8 ember tiles radially.",
        "  4: Ember Step    Drop a long-lasting ember at your feet.",
        "  5: Conflagration (ULT)  All embers reignite for 4s.",
        "  TIP: Chase the boss constantly — you need tile coverage.",
    ],
    "Bosses": [
        "─── The Warden (Boss 1) ─────────────────────────────",
    ...
    "Tips": [
        ...
        "",
        "─── New Class Tips ───────────────────────────────────",
        "  Undertaker: Chain Drag into Axe spam for quick stacks.",
        "  Glasswright: Place a triangle of panes, then Prism Blast.",
        "  Bellwether: Wall Mode during boss attacks, Rally during openings.",
        "  Ashwalker:  Never stand still. Embers only work if boss walks in.",
    ],
}
